<template>
  <div class="policy">
    ...
    <ul>
      ...
      <li>
        <p><strong>Application</strong> refers to portfolio, the software
          program provided by the Company.</p>
      </li>
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the
          Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
          this Agreement) refers to Bader Idris portfolio.</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Service</strong> refers to the Application or the Website or
          both.</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Third-party Social Media Service</strong> refers to any
          website or any social network website through which a User can log in
          or create an account to use the Service.</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Website</strong> refers to Bader Idris portfolio, accessible
          from <a href="baderidris.com" rel="external nofollow noopener"
            target="_blank">baderidris.com</a></p>
      </li>
      <li>
    ...
    <p>While using Our Application, in order to provide features of Our
    ...
    <ul>
      ...
      <li>Pictures and other information from your Device's camera and photo
        library</li>
    </ul>
    <p>We use this information to provide features of Our Service, to improve
    ...
    <ul>
      ...
      <li><strong>With Affiliates:</strong> We may share Your information with
        ...
        or that are under common control with Us.</li>
    ...
    <p>Our Service may give You the ability to delete certain information about
      You from within the Service.</p>
    <p>You may update, amend, or delete Your information at any time by signing
    ...
    <ul>
      <li>
        <p>By email: contact@baderidris.com</p>
      </li>
      <li>
        <p>By visiting this page on our website: <a
            href="https://baderidris.com/contact"
            rel="external nofollow noopener"
            target="_blank">https://baderidris.com/contact</a></p>
      </li>
      <li>
        <p>By phone number: 00970595744368</p>
      </li>
    </ul>
  </div>
</template>